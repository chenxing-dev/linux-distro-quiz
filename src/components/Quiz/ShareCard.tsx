...
export const ShareCard = ({ distro, shareUrl }: { distro: Distro; shareUrl: string }) => {
  return (
    <div className="w-[600px] h-[315px] bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-xl p-8 relative overflow-hidden shadow-2xl">
      {/* Background pattern */}
      ...
      <div className="flex h-full gap-6 relative z-10">
        ...
        <div className="flex-1 flex flex-col justify-between">
          <div>
            ...
            <h1 className="text-4xl font-bold text-white mb-4">{distro.name}</h1>
            <p className="text-zinc-300 text-lg max-w-md">{distro.description}</p>
          </div>
