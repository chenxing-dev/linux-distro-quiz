const questions = [
  {
    ...
    options: [
      ...
      { id: "f", text: "Salvage parts from 3 other laptops in my closet", traits: { kali: 3, gentoo: 2 } }
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    options: [
      { id: "a", text: "Premium experiences are worth the premium price", traits: { macos: 3, rhel: 3, nixos: 3, kali: 3 } },
      { id: "b", text: "I'll pay for convenience - but only after reading 10 comparison blogs", traits: { debian: 3, ubuntu: 3, popos: 2 } },
      { id: "c", text: "I'd rather donate to open-source maintainers", traits: { debian: 3, arch: 2 } },
      { id: "d", text: "I'd rather spend time than money", traits: { arch: 3, gentoo: 3, artix: 2 } },
      { id: "e", text: "Only if it has RGB lighting", traits: { popos: 3 } },
      { id: "f", text: "Money? I run Linux on a secondhand ThinkPad", traits: { arch: 3, gentoo: 2, mint: 2 } }
    ]
  },
  {
    id: 4,
